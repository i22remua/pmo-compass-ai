...
Production deployments: frontend `pmo-compass-9z7ji1vrc-alvaroredondo.vercel.app`, backend `pmo-compass-ai-8n1xby9ee-alvaroredondo.vercel.app`. Use the stable public aliases above. Deployment source came directly from the local working tree, before the GitHub release; the deployment identifiers identify the source snapshots independently of Git.
