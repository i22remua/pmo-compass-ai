...
async def main():
    ...
    for language in ('es', 'en'):
        ...
        for index, kind in [(0, 'weekly_status'), (1, 'risk_register'), (2, 'executive_brief'), (3, 'lessons_learned'), (4, 'meeting_minutes'), (5, 'weekly_status')]:
            result = await DemoAIProvider().generate(GenerationRequest(project=examples[language][index], type=kind, language=language))
    ...
    print('Rebuilt 12 bilingual demo documents in frontend/src/lib/demo-documents.json. No user data changed.')
